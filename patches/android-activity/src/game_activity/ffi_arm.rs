...
const _: () = {
    ["Size of GameActivityMotionEvent"]
        [::std::mem::size_of::<GameActivityMotionEvent>() - 1912usize];
    ...
    ["Offset of field: GameActivityMotionEvent::historySize"]
        [::std::mem::offset_of!(GameActivityMotionEvent, historySize) - 1884usize];
    ["Offset of field: GameActivityMotionEvent::historicalEventTimesMillis"]
        [::std::mem::offset_of!(GameActivityMotionEvent, historicalEventTimesMillis) - 1888usize];
    ["Offset of field: GameActivityMotionEvent::historicalEventTimesNanos"]
        [::std::mem::offset_of!(GameActivityMotionEvent, historicalEventTimesNanos) - 1892usize];
    ["Offset of field: GameActivityMotionEvent::historicalAxisValues"]
        [::std::mem::offset_of!(GameActivityMotionEvent, historicalAxisValues) - 1896usize];
    ["Offset of field: GameActivityMotionEvent::precisionX"]
        [::std::mem::offset_of!(GameActivityMotionEvent, precisionX) - 1900usize];
    ["Offset of field: GameActivityMotionEvent::precisionY"]
        [::std::mem::offset_of!(GameActivityMotionEvent, precisionY) - 1904usize];
};
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of user_fpregs_fp_reg"][::std::mem::size_of::<user_fpregs_fp_reg>() - 12usize];
    ["Alignment of user_fpregs_fp_reg"][::std::mem::align_of::<user_fpregs_fp_reg>() - 4usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of user_fpregs"][::std::mem::size_of::<user_fpregs>() - 116usize];
    ["Alignment of user_fpregs"][::std::mem::align_of::<user_fpregs>() - 4usize];
    ["Offset of field: user_fpregs::fpregs"][::std::mem::offset_of!(user_fpregs, fpregs) - 0usize];
    ["Offset of field: user_fpregs::ftype"][::std::mem::offset_of!(user_fpregs, ftype) - 104usize];
    ["Offset of field: user_fpregs::init_flag"]
        [::std::mem::offset_of!(user_fpregs, init_flag) - 112usize];
};
impl user_fpregs {
    #[inline]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of user_regs"][::std::mem::size_of::<user_regs>() - 72usize];
    ["Alignment of user_regs"][::std::mem::align_of::<user_regs>() - 4usize];
    ["Offset of field: user_regs::uregs"][::std::mem::offset_of!(user_regs, uregs) - 0usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct user_vfp {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of user_vfp"][::std::mem::size_of::<user_vfp>() - 264usize];
    ["Alignment of user_vfp"][::std::mem::align_of::<user_vfp>() - 8usize];
    ["Offset of field: user_vfp::fpregs"][::std::mem::offset_of!(user_vfp, fpregs) - 0usize];
    ["Offset of field: user_vfp::fpscr"][::std::mem::offset_of!(user_vfp, fpscr) - 256usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of user_vfp_exc"][::std::mem::size_of::<user_vfp_exc>() - 12usize];
    ["Alignment of user_vfp_exc"][::std::mem::align_of::<user_vfp_exc>() - 4usize];
    ["Offset of field: user_vfp_exc::fpexc"][::std::mem::offset_of!(user_vfp_exc, fpexc) - 0usize];
    ["Offset of field: user_vfp_exc::fpinst"]
        [::std::mem::offset_of!(user_vfp_exc, fpinst) - 4usize];
    ["Offset of field: user_vfp_exc::fpinst2"]
        [::std::mem::offset_of!(user_vfp_exc, fpinst2) - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct user {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of user"][::std::mem::size_of::<user>() - 296usize];
    ["Alignment of user"][::std::mem::align_of::<user>() - 4usize];
    ["Offset of field: user::regs"][::std::mem::offset_of!(user, regs) - 0usize];
    ["Offset of field: user::u_fpvalid"][::std::mem::offset_of!(user, u_fpvalid) - 72usize];
    ["Offset of field: user::u_tsize"][::std::mem::offset_of!(user, u_tsize) - 76usize];
    ["Offset of field: user::u_dsize"][::std::mem::offset_of!(user, u_dsize) - 80usize];
    ["Offset of field: user::u_ssize"][::std::mem::offset_of!(user, u_ssize) - 84usize];
    ["Offset of field: user::start_code"][::std::mem::offset_of!(user, start_code) - 88usize];
    ["Offset of field: user::start_stack"][::std::mem::offset_of!(user, start_stack) - 92usize];
    ["Offset of field: user::signal"][::std::mem::offset_of!(user, signal) - 96usize];
    ["Offset of field: user::reserved"][::std::mem::offset_of!(user, reserved) - 100usize];
    ["Offset of field: user::u_ar0"][::std::mem::offset_of!(user, u_ar0) - 104usize];
    ["Offset of field: user::magic"][::std::mem::offset_of!(user, magic) - 108usize];
    ["Offset of field: user::u_comm"][::std::mem::offset_of!(user, u_comm) - 112usize];
    ["Offset of field: user::u_debugreg"][::std::mem::offset_of!(user, u_debugreg) - 144usize];
    ["Offset of field: user::u_fp"][::std::mem::offset_of!(user, u_fp) - 176usize];
    ["Offset of field: user::u_fp0"][::std::mem::offset_of!(user, u_fp0) - 292usize];
};
...
const _: () = {
    ...
    ["Offset of field: ucontext::__padding"]
        [::std::mem::offset_of!(ucontext, __padding) - 112usize];
