...
const _: () = {
    ["Size of GameActivityMotionEvent"]
        [::std::mem::size_of::<GameActivityMotionEvent>() - 1952usize];
    ...
    ["Offset of field: GameActivityMotionEvent::historicalEventTimesNanos"]
        [::std::mem::offset_of!(GameActivityMotionEvent, historicalEventTimesNanos) - 1928usize];
    ["Offset of field: GameActivityMotionEvent::historicalAxisValues"]
        [::std::mem::offset_of!(GameActivityMotionEvent, historicalAxisValues) - 1936usize];
    ["Offset of field: GameActivityMotionEvent::precisionX"]
        [::std::mem::offset_of!(GameActivityMotionEvent, precisionX) - 1944usize];
    ["Offset of field: GameActivityMotionEvent::precisionY"]
        [::std::mem::offset_of!(GameActivityMotionEvent, precisionY) - 1948usize];
};
unsafe extern "C" {
