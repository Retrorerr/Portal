...
const _: () = {
    ["Size of GameActivityMotionEvent"]
        [::std::mem::size_of::<GameActivityMotionEvent>() - 1920usize];
    ...
    ["Offset of field: GameActivityMotionEvent::historicalEventTimesNanos"]
        [::std::mem::offset_of!(GameActivityMotionEvent, historicalEventTimesNanos) - 1896usize];
    ["Offset of field: GameActivityMotionEvent::historicalAxisValues"]
        [::std::mem::offset_of!(GameActivityMotionEvent, historicalAxisValues) - 1904usize];
    ["Offset of field: GameActivityMotionEvent::precisionX"]
        [::std::mem::offset_of!(GameActivityMotionEvent, precisionX) - 1912usize];
    ["Offset of field: GameActivityMotionEvent::precisionY"]
        [::std::mem::offset_of!(GameActivityMotionEvent, precisionY) - 1916usize];
};
unsafe extern "C" {
...
const _: () = {
    ["Size of sigcontext__bindgen_ty_1"]
        [::std::mem::size_of::<sigcontext__bindgen_ty_1>() - 2usize];
    ["Alignment of sigcontext__bindgen_ty_1"]
        [::std::mem::align_of::<sigcontext__bindgen_ty_1>() - 2usize];
    ["Offset of field: sigcontext__bindgen_ty_1::ss"]
        [::std::mem::offset_of!(sigcontext__bindgen_ty_1, ss) - 0usize];
    ["Offset of field: sigcontext__bindgen_ty_1::__pad0"]
        [::std::mem::offset_of!(sigcontext__bindgen_ty_1, __pad0) - 0usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ...
    ["Offset of field: sigcontext::reserved1"]
        [::std::mem::offset_of!(sigcontext, reserved1) - 192usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of user_fpregs_struct"][::std::mem::size_of::<user_fpregs_struct>() - 512usize];
    ["Alignment of user_fpregs_struct"][::std::mem::align_of::<user_fpregs_struct>() - 8usize];
    ...
    ["Offset of field: user_fpregs_struct::swd"]
        [::std::mem::offset_of!(user_fpregs_struct, swd) - 2usize];
    ["Offset of field: user_fpregs_struct::ftw"]
        [::std::mem::offset_of!(user_fpregs_struct, ftw) - 4usize];
    ["Offset of field: user_fpregs_struct::fop"]
        [::std::mem::offset_of!(user_fpregs_struct, fop) - 6usize];
    ["Offset of field: user_fpregs_struct::rip"]
        [::std::mem::offset_of!(user_fpregs_struct, rip) - 8usize];
    ["Offset of field: user_fpregs_struct::rdp"]
        [::std::mem::offset_of!(user_fpregs_struct, rdp) - 16usize];
    ["Offset of field: user_fpregs_struct::mxcsr"]
        [::std::mem::offset_of!(user_fpregs_struct, mxcsr) - 24usize];
    ["Offset of field: user_fpregs_struct::mxcr_mask"]
        [::std::mem::offset_of!(user_fpregs_struct, mxcr_mask) - 28usize];
    ["Offset of field: user_fpregs_struct::st_space"]
        [::std::mem::offset_of!(user_fpregs_struct, st_space) - 32usize];
    ["Offset of field: user_fpregs_struct::xmm_space"]
        [::std::mem::offset_of!(user_fpregs_struct, xmm_space) - 160usize];
    ["Offset of field: user_fpregs_struct::padding"]
        [::std::mem::offset_of!(user_fpregs_struct, padding) - 416usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Offset of field: user_regs_struct::rbp"]
        [::std::mem::offset_of!(user_regs_struct, rbp) - 32usize];
    ["Offset of field: user_regs_struct::rbx"]
        [::std::mem::offset_of!(user_regs_struct, rbx) - 40usize];
    ...
    ["Offset of field: user_regs_struct::rax"]
        [::std::mem::offset_of!(user_regs_struct, rax) - 80usize];
    ["Offset of field: user_regs_struct::rcx"]
        [::std::mem::offset_of!(user_regs_struct, rcx) - 88usize];
    ["Offset of field: user_regs_struct::rdx"]
        [::std::mem::offset_of!(user_regs_struct, rdx) - 96usize];
    ["Offset of field: user_regs_struct::rsi"]
        [::std::mem::offset_of!(user_regs_struct, rsi) - 104usize];
    ["Offset of field: user_regs_struct::rdi"]
        [::std::mem::offset_of!(user_regs_struct, rdi) - 112usize];
    ["Offset of field: user_regs_struct::orig_rax"]
        [::std::mem::offset_of!(user_regs_struct, orig_rax) - 120usize];
    ["Offset of field: user_regs_struct::rip"]
        [::std::mem::offset_of!(user_regs_struct, rip) - 128usize];
    ["Offset of field: user_regs_struct::cs"]
        [::std::mem::offset_of!(user_regs_struct, cs) - 136usize];
    ["Offset of field: user_regs_struct::eflags"]
        [::std::mem::offset_of!(user_regs_struct, eflags) - 144usize];
    ["Offset of field: user_regs_struct::rsp"]
        [::std::mem::offset_of!(user_regs_struct, rsp) - 152usize];
...
const _: () = {
    ...
    ["Offset of field: _libc_fpxreg::padding"]
        [::std::mem::offset_of!(_libc_fpxreg, padding) - 10usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Offset of field: _libc_fpstate::padding"]
        [::std::mem::offset_of!(_libc_fpstate, padding) - 416usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ucontext"][::std::mem::size_of::<ucontext>() - 816usize];
    ...
    ["Offset of field: ucontext::uc_mcontext"]
        [::std::mem::offset_of!(ucontext, uc_mcontext) - 40usize];
    ["Offset of field: ucontext::__fpregs_mem"]
        [::std::mem::offset_of!(ucontext, __fpregs_mem) - 304usize];
};
