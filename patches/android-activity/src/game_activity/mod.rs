...
mod portal_axis_patch_tests {
    ...
    #[test]
    fn gesture_axes_50_51_are_within_range() {
        assert!(50 < ffi::GAME_ACTIVITY_POINTER_INFO_AXIS_COUNT);
        assert!(51 < ffi::GAME_ACTIVITY_POINTER_INFO_AXIS_COUNT);
    }
