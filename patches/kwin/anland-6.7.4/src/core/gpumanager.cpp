...
void GpuManager::scanForRenderDevices()
{
    if (qEnvironmentVariableIntValue("ANLAND_NO_DRM_DEVICE") == 1) {
        qCInfo(KWIN_CORE) << "ANLAND_NO_DRM_DEVICE=1; skipping generic DRM render-device discovery";
        return;
    }
