...
# ---------------------------------------------------------------------------
# Quarantined legacy graphics overlay
#
# The pre-Forky lfdevs KWin 6.3.6/-95 and XWayland 24.1.6/-91 overlay was
# removed from the active rootfs builder. This builder now produces only the
# Debian Forky dependency closure; the app-staged Forky KWin assets are
# verified separately by assets/graphics-stack-lock.json.
#
# Historical source, patch, and binary records remain under patches/ and
# assets/xwayland-candidate/ for auditability, but there is deliberately no
# callable overlay downloader or package substitution API here.
# ---------------------------------------------------------------------------
