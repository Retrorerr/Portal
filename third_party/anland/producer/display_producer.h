/* Vendored verbatim from SuperTurtleDev/anland (legacy branch) as the
 * producer API reference (implemented by the lfdevs Anland KWin backend in
 * the guest). Portal's host side only needs the wire behavior documented
 * here; see src/android/anland/ for the Rust consumer/broker.
 * Origin: https://github.com/SuperTurtleDev/anland
 * File: libdisplay_producer/display_producer.h @ legacy HEAD aab290e0
