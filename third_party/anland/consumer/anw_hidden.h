/* Vendored verbatim from lfdevs/anland-termux (main branch) as the hidden
 * ANativeWindow ABI reference. Portal redeclares the needed subset in Rust
 * (src/android/anland/anw.rs); this header pins the exact struct layouts.
 * Origin: https://github.com/lfdevs/anland-termux
 * File: app/src/main/jni/anw_hidden.h @ main HEAD 23c77435032e7d9df00f40b90ecee04f1fc4ad9e
 * License: GPL-3.0 (see third_party/anland/ATTRIBUTION.md).
 * Do NOT edit.
 */
#ifndef ANW_HIDDEN_H
#define ANW_HIDDEN_H
