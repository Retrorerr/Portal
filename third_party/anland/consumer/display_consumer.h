 ...
 * consumer API reference. Portal reimplements this state machine in Rust
 * (src/android/anland/); this header pins the exact semantics.
 * Origin: https://github.com/SuperTurtleDev/anland
 * File: libdisplay_consumer/display_consumer.h @ legacy HEAD aab290e0
